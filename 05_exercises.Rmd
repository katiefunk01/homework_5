...
anim_save("late_trains_year")
```

```{r}
knitr::include_graphics("late_trains_year")
```
...
```{r}
knitr::include_graphics("cum_tomato_weight")
```
...
anim_save("mallorca_bike_ride_gif")
```
 
```{r}
knitr::include_graphics("mallorca_bike_ride_gif")
```
...
anim_save("panama_race_gif")

```

```{r}
knitr::include_graphics("panama_race_gif")
```
...
```{r}
knitr::include_graphics("covid_gif")
```
...
covid19 %>%
  ...
  filter(date == max(date),
         fridays = wday(date, label = TRUE) == "Fri") %>%
